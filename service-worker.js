const CACHE='homebound-v7-direct-payment-save';
const ASSETS=['./','./index.html','./styles.css?v=6','./app.js?v=7','./manifest.webmanifest','./assets/homebound-icon-180.png','./assets/homebound-icon-192.png','./assets/homebound-icon-512.png','./assets/home-hero-static.jpg','./assets/home-hero-family.svg'];
