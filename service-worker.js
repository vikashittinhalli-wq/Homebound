const CACHE='homebound-foundation-v2-migration-fix';
const ASSETS=['./','./index.html','./styles.css?v=10','./app.js?v=10','./manifest.webmanifest','./assets/homebound-icon-180.png','./assets/homebound-icon-192.png','./assets/homebound-icon-512.png','./assets/home-hero-static.jpg','./assets/home-hero-family.svg'];
