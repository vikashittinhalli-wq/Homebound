const CACHE='homebound-foundation-v3-zero-recovery';
const ASSETS=['./','./index.html','./styles.css?v=11','./app.js?v=11','./manifest.webmanifest','./assets/homebound-icon-180.png','./assets/homebound-icon-192.png','./assets/homebound-icon-512.png','./assets/home-hero-static.jpg','./assets/home-hero-family.svg'];
