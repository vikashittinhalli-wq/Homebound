...
const ASSETS=['./','./index.html','./styles.css?v=3','./app.js?v=3','./manifest.webmanifest','./assets/homebound-icon-180.png','./assets/homebound-icon-192.png','./assets/homebound-icon-512.png','./assets/home-hero-static.jpg'];
